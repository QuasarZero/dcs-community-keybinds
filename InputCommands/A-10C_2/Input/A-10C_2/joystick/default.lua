...
return {
	keyCommands = join(keyCommandsRadio, {
		...
		{cockpit_device_id = 75, down = 3001, value_down = -1, name = _('HMCS Power Switch - BATTERY'), category = {_('HMCS Power'), _('Custom')}},
		{cockpit_device_id = 75, down = 3001, value_down = 0, name = _('HMCS Power Switch - OFF'), category = {_('HMCS Power'), _('Custom')}},
		{cockpit_device_id = 75, down = 3001, value_down = 1, name = _('HMCS Power Switch - ON'), category = {_('HMCS Power'), _('Custom')}},
		{cockpit_device_id = 75, down = 3001, up = 3001, value_down = -1, value_up = 0, name = _('HMCS Power Switch - BATTERY else OFF (2-way Switch)'), category = {_('HMCS Power'), _('Custom')}},
		{cockpit_device_id = 75, down = 3001, up = 3001, value_down = 1, value_up = 0, name = _('HMCS Power Switch - ON else OFF (2-way Switch)'), category = {_('HMCS Power'), _('Custom')}},
		...
		{down = 3007, cockpit_device_id = 39, value_down = 1.0,  name = _('Canopy Open'), category = {_('Custom'), _('Systems')}},
		...
		{down = 3007, up = 3007, cockpit_device_id = 39, value_down = 1.0, value_up = 0.5, name = _('Canopy Open else Hold (2-way Switch) '), category = {_('Custom'), _('Systems')}},
